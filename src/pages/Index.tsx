              ...
              {recentProducts.map(product => (
                <Card key={product.id} className="overflow-hidden hover:shadow-lg transition-shadow">
                  <div className="aspect-square relative overflow-hidden bg-gray-100">
                    {product.images?.[0]?.src ? <img src={product.images[0].src} alt={product.name} className="object-cover w-full h-full" /> : <div className="flex items-center justify-center w-full h-full bg-gray-100">
                  ...
                  <CardContent>
                    <div className="space-y-2">
                      ...
                      {product.stock_quantity !== null && <div className="flex items-center justify-between">
